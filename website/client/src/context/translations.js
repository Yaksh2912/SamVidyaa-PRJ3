  ...
  en: {
    ...
    forms: {
      ...
      task: {
        ...
        modeAiDesc: 'Describe it, AI drafts it',
        modeManual: 'Write manually',
        modeManualDesc: 'Fill in the details yourself',
        modeImport: 'Import from file',
        modeImportDesc: 'Upload a PDF, DOC, or sheet',
        advancedOptions: 'Advanced options',
        advancedHelp: 'Deadline, collaboration, samples, and constraints',
        ai: {
          title: 'Generate With AI',
          help: 'Describe the tasks you want and AI will draft them. You can review and edit everything before saving — nothing is saved automatically.',
          badge: 'AI Assist',
          promptLabel: 'Describe the tasks you want',
          promptPlaceholder: 'e.g., 3 array problems on prefix sums and sliding window',
          countLabel: 'How many tasks?',
          difficultyLabel: 'Difficulty',
          languageLabel: 'Language',
          anyOption: 'Any',
          generate: 'Generate',
          generating: 'Generating...',
          reviewTitle: 'Review Generated Tasks ({count})',
          reviewHelp: 'Expand any task to edit its full details and test cases, then save. Use “Load Into Form” to fine-tune one task with all options.',
          reviewAnnounce: '{count} tasks generated. Expand each one to review and edit it before saving.',
          untitled: 'Untitled task',
          pointsPill: '{count} pts',
          testCasesCount: '{count} test cases',
          noTestCases: 'No test cases yet. Add at least one so students can be graded.',
          removeTask: 'Remove task',
          saveAll: 'Save {count} Tasks',
          savingAll: 'Saving...',
          discard: 'Discard All',
          promptRequired: 'Please describe the tasks you want to generate.',
          failed: 'Failed to generate tasks. Please try again.',
          empty: 'The AI did not return any usable tasks. Try refining your prompt.',
          createdMany: '{count} AI tasks created successfully!',
          filledForm: 'Draft ready below — review and save when you are happy with it.'
        },
        taskName: 'Task Name',
  ...
  hi: {
    ...
    forms: {
      ...
      task: {
        ...
        modeAi: 'AI से बनाएं',
        modeAiDesc: 'विवरण दें, AI ड्राफ्ट बनाएगा',
        modeManual: 'स्वयं लिखें',
        modeManualDesc: 'विवरण खुद भरें',
        modeImport: 'फाइल से इम्पोर्ट करें',
        modeImportDesc: 'PDF, DOC या शीट अपलोड करें',
        advancedOptions: 'उन्नत विकल्प',
        advancedHelp: 'अंतिम तिथि, सहयोग, नमूने और सीमाएँ',
        ai: {
          title: 'AI से बनाएं',
          help: 'आप जो कार्य चाहते हैं उसका विवरण दें और AI उनका ड्राफ्ट बनाएगा। सहेजने से पहले आप सब कुछ देख और संपादित कर सकते हैं — कुछ भी अपने आप सहेजा नहीं जाता।',
          badge: 'AI सहायता',
          promptLabel: 'आप जो कार्य चाहते हैं उसका विवरण दें',
          promptPlaceholder: 'जैसे, prefix sums और sliding window पर 3 array समस्याएँ',
          countLabel: 'कितने कार्य?',
          difficultyLabel: 'कठिनाई',
          languageLabel: 'भाषा',
          anyOption: 'कोई भी',
          generate: 'बनाएं',
          generating: 'बनाया जा रहा है...',
          reviewTitle: 'बनाए गए कार्यों की समीक्षा करें ({count})',
          reviewHelp: 'किसी भी कार्य को विस्तृत करके उसका पूरा विवरण और टेस्ट केस संपादित करें, फिर सहेजें। सभी विकल्पों के साथ किसी एक कार्य को ठीक करने के लिए “फॉर्म में लोड करें” का उपयोग करें।',
          reviewAnnounce: '{count} कार्य बनाए गए। सहेजने से पहले प्रत्येक को विस्तृत करके समीक्षा और संपादित करें।',
          untitled: 'बिना शीर्षक कार्य',
          pointsPill: '{count} अंक',
          testCasesCount: '{count} टेस्ट केस',
          noTestCases: 'अभी कोई टेस्ट केस नहीं। कृपया कम से कम एक जोड़ें ताकि छात्रों का मूल्यांकन हो सके।',
          removeTask: 'कार्य हटाएं',
          saveAll: '{count} कार्य सहेजें',
          savingAll: 'सहेजा जा रहा है...',
          discard: 'सभी हटाएं',
          promptRequired: 'कृपया उन कार्यों का विवरण दें जिन्हें आप बनाना चाहते हैं।',
          failed: 'कार्य नहीं बनाए जा सके। कृपया पुनः प्रयास करें।',
          empty: 'AI ने कोई उपयोगी कार्य नहीं लौटाया। कृपया अपना विवरण सुधारें।',
          createdMany: '{count} AI कार्य सफलतापूर्वक बनाए गए!',
          filledForm: 'ड्राफ्ट नीचे तैयार है — संतुष्ट होने पर समीक्षा करें और सहेजें।'
        },
        taskName: 'कार्य नाम',
